...
Motors::Motors(structMotorConfig &c1, structMotorConfig &c2, structMotorConfig &c3, structPid *pid) : m1(SingleMotor(c1, pid)), m2(SingleMotor(c2, pid)), m3(SingleMotor(c3, pid))
{
	this->motors[0] = &m1;
	this->motors[1] = &m2;
	this->motors[2] = &m3;
...
void Motors::updateEncoderMotor1A()
{
	this->m1.updateEncoderA();
}

void Motors::updateEncoderMotor1B()
{
	this->m1.updateEncoderB();
}

void Motors::updateEncoderMotor2A()
{
	this->m2.updateEncoderA();
}

void Motors::updateEncoderMotor2B()
{
	this->m2.updateEncoderB();
}

void Motors::updateEncoderMotor3A()
{
	this->m3.updateEncoderA();
}
void Motors::updateEncoderMotor3B()
{
	this->m3.updateEncoderB();
}
